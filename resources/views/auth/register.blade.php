                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="gender" type="gender" class="form-control" name="gender" required autocomplete="new-gender">
                        ...
                        <!-- 身長 -->
                        <div class="form-group row">
                            <label for="height" class="col-md-4 col-form-label text-md-right">{{ __('messages.Height') }}</label>

                            <div class="col-md-6">
                                <select id="height" type="height" class="form-control" name="height" required autocomplete="new-height">
                                    <?php
                                    for ($i = 140; $i <=210; $i++) {
